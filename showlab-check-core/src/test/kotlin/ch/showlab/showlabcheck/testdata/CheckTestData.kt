...
object CheckTestData {
    ...
    val check = Check(
            ...
            questionCategories = listOf(
                    ...
                    QuestionCategoryTestData.questionCategory2
            )
    )

    val checkDto = CheckDTO(
            id = 1L,
            customerId = CustomerTestData.customer.id,
            title = "Check One",
            activeFrom = LocalDateTime.parse("2020-01-01T09:00:00"),
            activeTo = LocalDateTime.parse("2020-01-10T09:00:00"),
            questionCategories = listOf(
                    QuestionCategoryTestData.questionCategoryDTO,
                    QuestionCategoryTestData.questionCategory2DTO
            )
    )
}
